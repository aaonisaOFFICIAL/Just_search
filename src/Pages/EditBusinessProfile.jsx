...
import MultipleSelectCheckmarks from "../Components/BuissnessListening/Checkbox";
...
const EditBusinessProfile = () => {
  ...
  return (
    <div>
      <HomeNavbar />
      <div className="listening-form m-auto">
        {/* {currentStep === 1 && (
        ...
        {currentStep === 3 && (
          <div className="form-three">
            ...
            <p>Let your customers know when you are available for them</p>
